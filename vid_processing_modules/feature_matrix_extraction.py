...
from feature_extraction import (
    load_audio_chunk,
    prepare_horn_template,
    extract_detector_features,
)

# convenience.py

# Example list of videos where the original detector/crop failed.
# In a real project, replace these filenames with manually reviewed failures.
FAILED_CUTS_new = ["video_003.mp4","video_007.mp4","video_012.mp4","video_018.mp4","video_024.mp4",]
...
for video_file in video_files:
    ...
    label = 0 if video_file in FAILED_CUTS_new else 1
    ...
    for start_sec, end_sec in WINDOWS:
        ...
        rows.append({"video_file": video_file,"window_start": start_sec,"window_end": end_sec,**features,"label": label,})
